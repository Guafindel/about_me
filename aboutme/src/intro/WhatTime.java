...
public class WhatTime extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(!dirParam.equals("/")) {
                String parentDir = dirParam.substring(0, originDir.lastIndexOf("/"));
        ...
        request.setAttribute("requestUrl", "/aboutme/what-time?dir=");

        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/jsp/whattime.jsp");
